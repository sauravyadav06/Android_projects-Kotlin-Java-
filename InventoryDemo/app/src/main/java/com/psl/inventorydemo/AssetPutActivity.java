...
public class AssetPutActivity extends AppCompatActivity {
    private Context context = this;
    ActivityAssetPutBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_asset_put);
    ...
    public class CollectInventoryData extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
                try {
                    ...
                    jsonobject.put(APIConstants.K_ACTIVITY_TYPE, "PUT");
